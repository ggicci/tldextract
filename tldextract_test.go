...
func TestAll(t *testing.T) {
	cases := map[string]*Result{"http://www.google.com": &Result{Flag: Domain, Sub: "www", Root: "google", Tld: "com"},
		...
		"http://șaorma.ro":                                &Result{Flag: Domain, Sub: "", Root: "șaorma", Tld: "ro"},
		...
		"c.cy":                &Result{Flag: Malformed},
		"b.c.cy":              &Result{Flag: Domain, Sub: "", Root: "b", Tld: "c.cy"},
		"a.b.c.cy":            &Result{Flag: Domain, Sub: "a", Root: "b", Tld: "c.cy"},
